...
summary.lm(simp)
```
the adjusted r square that is largest and the best. The neck size is 0.7476.
...
Considering the adjusted r square for all od these considering which is the adjusted r square is the best shown from the graphs above. Consulting head size opposed to the others is best. 
